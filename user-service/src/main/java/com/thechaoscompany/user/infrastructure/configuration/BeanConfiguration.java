...
import com.thechaoscompany.user.domain.usecase.UserUseCase;
...
public class BeanConfiguration {
    ...
    @Bean
    public UserServicePort userServicePort(UserPersistensePort userPersistensePort) {
        return new UserUseCase(userPersistensePort);
    }
}